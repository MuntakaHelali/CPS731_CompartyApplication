    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddComponent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                Intent intent = new Intent(RAM.this, AddEditComponentActivity.class);
        ...
        componentViewModel.getAllRAMS().observe(this, new Observer<List<Component>>() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(RAM.this, "Component Deleted", Toast.LENGTH_LONG).show();
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.delete_all_components:
                componentViewModel.deleteAllRam();
