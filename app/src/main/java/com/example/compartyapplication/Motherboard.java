    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonAddComponent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                Intent intent = new Intent(Motherboard.this, AddEditComponentActivity.class);
        ...
        componentViewModel.getAllMotherBoards().observe(this, new Observer<List<Component>>() {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0,
            ...
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                ...
                Toast.makeText(Motherboard.this, "Component Deleted", Toast.LENGTH_LONG).show();
            }
